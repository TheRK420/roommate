<?php
/*
Template Name: Roommates : Roommates Directory & Listings HTML templates
...
try {
    if (!empty($_POST)) {
		...
		$dzMailSubject = 'Roommates|Contact Form: A Person want to contact';
		$dzMailMessage	= 	"
