...
// new function added to solve the bug of backend to the description
...
function formEditor() {
    ...
    try{
        const div = document.querySelector(".description-content")
        const observer = new MutationObserver((mutationRecords) => {
            let data = div.firstChild
            data = data.innerHTML
            let input = document.querySelector(".description-content-input")
            input.value = data
            console.log(input.value)
            console.log(document.querySelector(".description-content-input").value)
            console.log("shiv")
